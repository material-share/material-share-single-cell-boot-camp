...
The BD Rhapsody™ Targeted mRNA Kits profile a subset of genes, usually ranging from dozens to hundreds.

In Chapter 2, we introduce filtering low quality cell labels using WTA assays. WTA assays profile whole transcriptome which includes 25000 to 30000 genes. Because the profiled gene number is substantially lower in targeted assays and very often the targeted assays do not include mitochondrial genes, the filtering cutoff for low quality cell labels in WTA assays is different from the one for targeted assays.
