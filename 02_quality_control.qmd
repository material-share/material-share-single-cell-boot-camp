...
For an example on how to analyze targeted assay, please look at "Supplementary: Data import and quality control of targeted assays".
:::
...
::: callout-tip
The name patterns of mitochondrial genes are different genome versions. To make sure that the mitochondrial percentage is calculated correctly, one can use grep to check the gene name pattern of mitochondrial genes. For example, the demo dataset has mitochondrial genes starting with "MT-".
