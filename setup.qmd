...
Please access the folder [Data](https://bd1-my.sharepoint.com/:u:/r/personal/yujuan_gui_bd_com/Documents/11_demo_data/data_for_boot_camp/data_for_boot_camp.zip?csf=1&web=1&e=e27OTV) to download data to run the prerequisites and course chapters.
...
The teaching materials run on `Seurat` V4. Please check the version of `SeuratObject` and `Seurat`.
