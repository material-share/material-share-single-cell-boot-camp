...
mrna_data %>% dplyr::select(cell_status)
```
...
#display last column
signal_cells %>% dplyr::select(last_col())
```
...
#display results
mrna_data %>% dplyr::select(last_col()) #chose last column from mrna_data
```
